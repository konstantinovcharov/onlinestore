...
export class AdmincartsComponent implements OnInit, OnDestroy {
  ...
  setData(formData) {
    this.dataLoading = true;
    this.querySubscription = this._backendService.getDocs('cart', formData)
    .subscribe(members => {
      if (members) {
  ...
  updateData(formData) {
    this.dataLoading = true;
    this.querySubscription = this._backendService.updateDocs('cart', formData)
    .then((res) => {
      this.savedChanges = true;
      this.dataLoading = false;
    }).catch(error => {
  ...
  deleteDoc(docId){
    ...
    this.dataLoading = true;
    this.querySubscription = this._backendService.delOneDoc('cart', docId)
    .then((res) => {
