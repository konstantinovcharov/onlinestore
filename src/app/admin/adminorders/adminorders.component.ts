...
export class AdminordersComponent implements OnInit, OnDestroy {
  ...
  setData(formData) {
    this.dataLoading = true;
    this.querySubscription = this._backendService.setDocs('orders', formData)
        .then((res) => {
  ...
  updateData(formData) {
    this.dataLoading = true;
    this.querySubscription = this._backendService.updateDocs('orders', formData)
    .then((res) => {
      this.savedChanges = true;
      this.dataLoading = false;
    }).catch(error => {
  ...
  deleteDoc(docId){
    ...
    this.dataLoading = true;
    this.querySubscription = this._backendService.delOneDoc('orders', docId)
    .then((res) => {
